...
import { ExtendedError, Namespace, ServerReservedEventsMap } from "../../../backend/node_modules/socket.io/dist/namespace";
import { Adapter, Room, SocketId } from "socket.io-adapter";
import * as parser from "socket.io-parser";
import type { Encoder } from "socket.io-parser";
import { Socket } from "../../../backend/node_modules/socket.io/dist/socket";
import { DisconnectReason } from "../../../backend/node_modules/socket.io/dist/socket-types";
import type { BroadcastOperator, RemoteSocket } from "../../../backend/node_modules/socket.io/dist/broadcast-operator";
import { EventsMap, DefaultEventsMap, EventParams, StrictEventEmitter, EventNames, DecorateAcknowledgementsWithTimeoutAndMultipleResponses, AllButLast, Last, RemoveAcknowledgements, EventNamesWithAck, FirstNonErrorArg } from "../../../backend/node_modules/socket.io/dist/typed-events";
...
SocketData = any> extends StrictEventEmitter<ServerSideEvents, RemoveAcknowledgements<EmitEvents>, ServerReservedEventsMap<ListenEvents, EmitEvents, ServerSideEvents, SocketData>> {
     ...
     */
    to(room: Room | Room[]): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    in(room: Room | Room[]): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    except(room: Room | Room[]): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    compress(compress: boolean): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    get volatile(): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    get local(): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @param timeout
     */
    timeout(timeout: number): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgements<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>>, SocketData>;
    /**
...
export { Event } from "../../../backend/node_modules/socket.io/dist/socket";
