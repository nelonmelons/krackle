...
import { EventParams, EventNames, EventsMap, StrictEventEmitter, DefaultEventsMap, DecorateAcknowledgementsWithTimeoutAndMultipleResponses, AllButLast, Last, DecorateAcknowledgementsWithMultipleResponses, RemoveAcknowledgements, EventNamesWithAck, FirstNonErrorArg, EventNamesWithoutAck } from "../../../backend/node_modules/socket.io/dist/typed-events";
import type { Client } from "../../../backend/node_modules/socket.io/dist/client";
import type { Adapter, Room, SocketId } from "socket.io-adapter";
import { BroadcastOperator } from "../../../backend/node_modules/socket.io/dist/broadcast-operator";
...
export declare class Namespace<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ServerSideEvents, RemoveAcknowledgements<EmitEvents>, NamespaceReservedEventsMap<ListenEvents, EmitEvents, ServerSideEvents, SocketData>> {
     ...
     * @param timeout
     */
    timeout(timeout: number): BroadcastOperator<import("../../../backend/node_modules/socket.io/dist/typed-events").DecorateAcknowledgements<DecorateAcknowledgementsWithMultipleResponses<EmitEvents>>, SocketData>;
    /**
     ...
     * }
     */
    fetchSockets(): Promise<import("../../../backend/node_modules/socket.io/dist/broadcast-operator").RemoteSocket<EmitEvents, SocketData>[]>;
    /**
